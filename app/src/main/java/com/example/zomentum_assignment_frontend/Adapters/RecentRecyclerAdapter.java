...
public class RecentRecyclerAdapter extends RecyclerView.Adapter<RecentRecyclerAdapter.ViewHolder> {
    ...
    public  RecentRecyclerAdapter(Context mContext, ArrayList<FriendDetailsClass> friends, boolean isChat){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        RecentRecyclerAdapter.ViewHolder vh = new RecentRecyclerAdapter.ViewHolder(v);
        return vh;
    }
